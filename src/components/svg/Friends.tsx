...
const Friends:React.FC<IProps> = ({height,width,color}) => {
    return <svg fill="none" height={`${height}`} viewBox="0 0 20 20" width={`${width}`} xmlns="http://www.w3.org/2000/svg">
        <g fill={`${color}`}><g clipRule="evenodd" fillRule="evenodd">
